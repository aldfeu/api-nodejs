...
Rest.prototype.upload = function(params, callbackSuccess, callbackError, callbackProgress) {
  var self = this;
  var fs = require('fs');
  var qs = {};
  if (self.token) {
  ...
  getToken(params.file, function(error, response) {
    var formData = Object.assign({}, response, {
      file: fs.createReadStream(params.file.path)
    });
